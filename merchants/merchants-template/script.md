...
These are ideal for scenarios without internet connectivity or for static websites enabling quick payments."
- **Visuals**:
...
- **Visuals**:
    ...
    - Emphasize the "Summary is editable" and "Amount is editable" options, as well as "OTP Device"
